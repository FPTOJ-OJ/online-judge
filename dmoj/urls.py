...
urlpatterns = [
    ...
    path('quiz/manage/exams/<int:exam_id>/analytics/', quiz_views.QuizExamAnalyticsView.as_view(), name='quiz_exam_analytics'),
    path('quiz/manage/exams/<int:exam_id>/monitor/', quiz_views.QuizExamLiveMonitorView.as_view(), name='quiz_exam_monitor'),
    path('quiz/manage/exams/<int:exam_id>/monitor/ajax/', quiz_views.QuizExamLiveMonitorAjaxView.as_view(), name='quiz_exam_monitor_ajax'),
    path('quiz/manage/exams/<int:exam_id>/proctor-action/', quiz_views.QuizExamProctorActionView.as_view(), name='quiz_exam_proctor_action'),
    path('quiz/manage/exams/<int:exam_id>/remediation/', quiz_views.QuizCreateRemediationAssignmentView.as_view(), name='quiz_exam_remediation'),
    path('quiz/manage/exams/<int:exam_id>/export/', quiz_views.QuizExamExportView.as_view(), name='quiz_exam_export'),
    path('quiz/manage/exams/<int:exam_id>/toggle-active/', quiz_views.QuizExamToggleActiveView.as_view(), name='quiz_exam_toggle_active'),
    path('quiz/manage/exams/<int:exam_id>/assign-classes/', quiz_views.QuizExamAssignBulkClassesView.as_view(), name='quiz_exam_assign_classes_ajax'),
    path('quiz/manage/exams/builder/', quiz_views.QuizExamBuilderView.as_view(), name='quiz_exam_builder'),
    ...
    path('quiz/class/<int:class_id>/members/action/', quiz_views.QuizClassMemberActionView.as_view(), name='quiz_class_member_action'),
    path('quiz/manage/class/create/', quiz_views.QuizClassCreateAjaxView.as_view(), name='quiz_class_create_ajax'),
    path('quiz/manage/class/<int:class_id>/edit/', quiz_views.QuizClassEditAjaxView.as_view(), name='quiz_class_edit_ajax'),
